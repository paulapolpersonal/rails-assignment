...
new_product.image.attach(io: File.open(file_path), filename: 'logo.png')
User.find_or_create_by!(name:"Paula Pol", email: "polpaula6@gmail.com", password:"administrator", password_confirmation:"administrator", admin: true, activated: true,
            activated_at: Time.zone.now)
User.find_or_create_by!(name:"Ana Pop", email: "anapop@gmail.com", password:"mamaliga", password_confirmation:"mamaliga", admin: false, activated: true,
            activated_at: Time.zone.now)